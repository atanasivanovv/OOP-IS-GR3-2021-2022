...
## Task 3 - Компютър
Създайте структура, която описва компютър с капацитет на батерията, размер на екрана, име на марката и описание. Направете инициализация с данни чрез директна промяна на член-данните и инициализация с конструктор.
